 ...
 *
 * NOTE: Updated to match actual demo-data-source/ file hashes
 * (road_network_geometry.json, emergency_traffic_sop.txt, live_incidents.json).
 */
export const DEFAULT_EXPECTED_HASHES: Record<string, string> = {
  ...
  'road_network_geometry.json': 'A539DE9A2CD6B349B67A013A054894A5651ACFDF0759B4DE455B71FA4C9F95B8',
  'emergency_traffic_sop.txt': '9DAAE6217F2751E7E91CF5D459B2EDE4C00B983AB6E995DC8F22F7996394BAF4',
  'live_incidents.json': 'E2BD5360F3C216DB7856FF8057647FC92DEFE71ADD6E60873FB57F010F0547A3',
};
